# sc2-distributed-marl-framework
...
__PPO__  
__IMPALA__  
In the [parameters.json](https://github.com/ymg1114/sc2-distributed-marl-framework/blob/main/utils/parameters.json) configuration file, you can replace the algorithm by changing the `algo` entry.  
...
In the [run.py](https://github.com/ymg1114/sc2-distributed-marl-framework/blob/main/run.py) script, you need to set the virtual environment name `vir_env_name`.  
In the [machines.json](https://github.com/ymg1114/sc2-distributed-marl-framework/blob/main/utils/machines.json) configuration file, you need to set the `account`, `IP`, and `port` for the machines to be used as __Learner__, __Manager__, and __Worker__.   
...
- Follow the [guide to build](https://github.com/ymg1114/sc2-distributed-marl-framework/tree/main/observer/cxx_flee_algo) the library from source.
